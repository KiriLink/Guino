                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col s12 m12 l4">
                                <h2>Nv.<span class="indigo-text title">{{ $loop->iteration }}</span></h2>
                            </div>
                            <div class="col s12 m12 l7 offset-l1">
                                @if ( $nivelActual == $loop->iteration)
                                <img src="{{ asset(auth()->user()->ruta_foto) }}" alt="" class="circle responsive-img logo">
                                @endif
                                {{-- <p>Categoría: <span class="indigo-text title">{{$pregunta->categoria}}</span></p> --}}
                                <div class="divider"></div>
                                @if ( $nivelActual != $loop->iteration)
                                <a href="{{ route('entrar_desafio') }}" class="waves-effect waves-light indigo btn-large" disabled><i class="material-icons left">play_arrow</i>Iniciar</a>
                                @elseif ( $nivelActual > $loop->iteration)
                                espere mas preguntas
                                @else
                                <a href="{{ route('entrar_desafio') }}" class="waves-effect waves-light indigo btn-large"><i class="material-icons left">play_arrow</i>Iniciar</a>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            <nav class="z-depth-0">
                <div class="nav-wrapper indigo">
                    <ul class="justify">
                        ...
                        @endif
                        <li><a class="active" href="{{ route('desafio') }}" style="background-color: #869DF1; border-radius: 10px;"><i class="material-icons indigo-text">grade</i></a></li>
